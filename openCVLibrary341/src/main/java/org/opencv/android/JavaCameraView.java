...
public class JavaCameraView extends CameraBridgeViewBase implements PreviewCallback
{
	...
	protected boolean initializeCamera(int width, int height)
	{
		...
		synchronized (this)
		{
			...
			try
			{
				...
				params.setExposureCompensation((params.getMaxExposureCompensation() / 2) - 2);
				...
				if (sizes != null)
				{
					...
					if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH && !android.os.Build.MODEL.equals("GT-I9100")) params.setRecordingHint(true);
	...
	private class JavaCameraFrame implements CvCameraViewFrame
	{
		...
		public JavaCameraFrame(Mat Yuv420sp, int width, int height)
		{
			...
			mRgba = new Mat(mHeight, mHeight, CvType.CV_8UC4);
		}
