 ...
 * required functions:mPreviewFormat
...
public class JavaCamera2View extends CameraBridgeViewBase
{
	...
	private int mPreviewFormat = ImageFormat.YUV_420_888/*ImageFormat.NV21*/;
		...
		try
		{
			...
			mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener()
			{
				...
				public void onImageAvailable(ImageReader reader)
				{
					...
					assert (mImage.getFormat() == mPreviewFormat);
	...
	protected boolean connectCamera(int width, int height)
	{
		...
		try
		{
			...
			if (BuildConfig.DEBUG) Log.d(LOGTAG, "mStretch value: " + mScale);
	...
	private class JavaCamera2Frame implements CvCameraViewFrame
	{
		...
		public void setBytes2Mat(byte[] yBytes, byte[] uvBytes)
		{
			mYuvFrameData.put(0,0, yBytes);
			mUVFrameData.put(0,0, uvBytes);
		}
		...
		public Mat rgba()
		{
			...
			else if (mPreviewFormat == ImageFormat.YUV_420_888)
			{
				...
				Imgproc.cvtColorTwoPlane(mYuvFrameData, mUVFrameData, mRgba, /*Imgproc.COLOR_YUV2RGBA_NV21*/Imgproc.COLOR_YUV2RGBA_NV12);
			}
			else
			{
